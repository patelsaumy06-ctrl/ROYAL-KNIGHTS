...
import { loginUser, registerUser, loginAnonymously } from '../services/authService';
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }}
          ...
          <form onSubmit={handleLogin}>
            ...
            <button type="button" onClick={handleGuestLogin} disabled={loading}
              style={{ width: "100%", padding: "14px", borderRadius: 12, border: "1.5px solid #E2E8F0", background: "#fff", color: "#334155", fontSize: 15, fontWeight: 700, cursor: loading ? "not-allowed" : "pointer", fontFamily: "'Inter',sans-serif", transition: "all 0.2s", display: "flex", alignItems: "center", justifyContent: "center", marginTop: 12, minHeight: 52 }}
